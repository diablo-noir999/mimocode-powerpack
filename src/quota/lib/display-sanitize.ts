...
/**
 * Sanitize an auth value (API key type, tier, etc.) for safe display in error messages.
 * Collapses whitespace, falls back to "unknown" for empty values, and caps at 120 chars.
 */
export function sanitizeAuthValue(value: string): string {
