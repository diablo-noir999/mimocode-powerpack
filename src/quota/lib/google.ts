...
import {
  mapWithConcurrency,
  refreshAccessToken,
  refreshAccessTokenWithCache as refreshAccessTokenWithCacheShared,
  GOOGLE_ACCOUNTS_CONCURRENCY,
...
/**
 * Local wrapper that unpacks credentials for the shared refreshAccessTokenWithCache.
 */
async function refreshAccessTokenWithCache(params: {
  ...
  return refreshAccessTokenWithCacheShared({
