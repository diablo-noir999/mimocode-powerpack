...
import { asRecord } from "./format-utils.js";
import { getAuthPaths, readAuthFileCached } from "./opencode-auth.js";
import { sanitizeDisplayText, sanitizeAuthValue } from "./display-sanitize.js";
...
const sanitizeAlibabaAuthValue = sanitizeAuthValue;
