 ...
 * - Various provider files (asRecord, coerceFiniteNumber)
 */

import type { PercentDisplayMode } from "./types.js";

// === Shared type guards / coercion helpers ===

/**
 * Cast a value to Record<string, unknown> if it's a non-null, non-array object.
 * Returns null for primitives, null, arrays, or functions.
 */
 ...
 * Accepts numbers and numeric strings (with optional trimming).
 * Returns undefined for non-coercible values.
 */
