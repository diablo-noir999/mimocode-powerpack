/**
 * Skill metadata — tracks install source for sync
 *
 * Adapted from dev/openskills/src/utils/skill-metadata.ts
 */

import { existsSync, readFileSync, writeFileSync } from "fs"
import { join } from "path"

export const SKILL_METADATA_FILE = ".mimocode-skill-meta.json"
